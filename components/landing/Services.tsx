  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Título y subtítulo */}
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 font-montserrat mb-16">
          <h2 className="text-3xl sm:text-4xl font-semibold leading-tight text-left">
        ...
        {/* Cards de servicios con márgenes laterales */}
